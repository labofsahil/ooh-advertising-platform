 ...
 */
import { createInventory as api_inventory_create_inventory_createInventory } from "~backend/inventory/create_inventory";
import { createOrganization as api_inventory_create_organization_createOrganization } from "~backend/inventory/create_organization";
import { deleteInventory as api_inventory_delete_inventory_deleteInventory } from "~backend/inventory/delete_inventory";
import { getInventory as api_inventory_get_inventory_getInventory } from "~backend/inventory/get_inventory";
import { listInventory as api_inventory_list_inventory_listInventory } from "~backend/inventory/list_inventory";
import { listOrganizations as api_inventory_list_organizations_listOrganizations } from "~backend/inventory/list_organizations";
import { updateInventory as api_inventory_update_inventory_updateInventory } from "~backend/inventory/update_inventory";
...
export namespace inventory {
    ...
    export class ServiceClient {
         ...
         */
        public async createInventory(params: RequestType<typeof api_inventory_create_inventory_createInventory>): Promise<ResponseType<typeof api_inventory_create_inventory_createInventory>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/inventory`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_inventory_create_inventory_createInventory>
        }

        /**
         * Creates a new organization that can manage inventory listings.
         */
        public async createOrganization(params: RequestType<typeof api_inventory_create_organization_createOrganization>): Promise<ResponseType<typeof api_inventory_create_organization_createOrganization>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/organizations`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_inventory_create_organization_createOrganization>
        }

        /**
         * Deletes an inventory listing owned by the authenticated user.
         */
        public async deleteInventory(params: { id: number }): Promise<void> {
            await this.baseClient.callTypedAPI(`/inventory/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
        }

        /**
         * Retrieves a specific inventory listing by ID.
         */
        public async getInventory(params: { id: number }): Promise<ResponseType<typeof api_inventory_get_inventory_getInventory>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/inventory/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_inventory_get_inventory_getInventory>
        }
        ...
        public async listInventory(params: RequestType<typeof api_inventory_list_inventory_listInventory>): Promise<ResponseType<typeof api_inventory_list_inventory_listInventory>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/inventory`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_inventory_list_inventory_listInventory>
        }

        /**
         * Retrieves all organizations owned by the authenticated user.
         */
        public async listOrganizations(): Promise<ResponseType<typeof api_inventory_list_organizations_listOrganizations>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/organizations`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_inventory_list_organizations_listOrganizations>
        }
        ...
        public async updateInventory(params: RequestType<typeof api_inventory_update_inventory_updateInventory>): Promise<ResponseType<typeof api_inventory_update_inventory_updateInventory>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/inventory/${encodeURIComponent(params.id)}`, {method: "PUT", body: JSON.stringify(body)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_inventory_update_inventory_updateInventory>
        }
    }
}
