...
```bash
git remote add encore encore://ooh-advertising-platform-ugxi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ooh-advertising-platform-ugxi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ooh-advertising-platform-ugxi/settings/integrations/github)
